defmodule ExPassword.FindAlgorithmTest do
  ...
  describe "ExPassword.find_algorithm/1" do
    test "find a supported algorithm" do
      # MD5("")
      assert ExPassword.MD5 == ExPassword.find_algorithm("d41d8cd98f00b204e9800998ecf8427e")
      # SHA1("")
      assert ExPassword.SHA1 == ExPassword.find_algorithm("da39a3ee5e6b4b0d3255bfef95601890afd80709")
    end
